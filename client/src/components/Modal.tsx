    ...
    >
      <div>
        <div
          ...
          dark:bg-gradient-to-tl dark:from-[#B3C1FF] dark:via-[#BFDCFF] dark:to-[#A2D4E8] ${
        ...
        >
          ...
          <div
            ...
            dark:bg-gradient-to-tl dark:from-[#B3C1FF] dark:via-[#BFDCFF] dark:to-[#A2D4E8] dark:hover:bg-white dark:hover:border-black dark:hover:bg-opacity-90`}
